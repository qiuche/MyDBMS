...
public class SysLogAspect {
    ...
    @Autowired
    private SysLogServiceImp sysLogService;
     ...
     * 切点表达式:   execution(...)
     */
    @Pointcut("@annotation(com.schoolwork.desktopapp.Log.SysLog)")
     ...
     * @param time
     */
    private void saveLog(ProceedingJoinPoint joinPoint, long time, String status) throws Exception {
        ...
        if(sysLogBO.getClassName().equals("com.schoolwork.desktopapp.controller.CreateController")&&sysLogBO.getMethodName().equals("createTables")&&sysLogBO.getStatus().equals("SUCCESS"))
        {
